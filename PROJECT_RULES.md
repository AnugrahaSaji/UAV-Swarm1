...
## Lab Context (IPs + Pi repo path)

**Single source of truth (machine-local, not committed):**
...
Details: docs/lab-context.md

Policy: never hard-code lab IPs in skills/docs; run devtools/ip_consistency_check.py before any networked run.
