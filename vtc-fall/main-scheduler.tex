...
\title{Scheduler Decision-Space Analysis\\
{\normalsize Deep Dive: MDEAS Policy, Constraints, and Cross-Axis Effects}}
\author{VTC Fall 2026 — Supplementary Analysis}
\maketitle

\input{results-scheduler-analysis.tex}
